...
const schools = graduates.map( (universities) => {
  return universities.university;
})
const universities = schools.sort();            
console.log(universities);                 // COMPLETE
...
console.log(contactInfo);         // COMPLETE



/* Request 3: Find out how many universities have the string "Uni" included in their name. Create a new array called unisWithUni that contains them all. This will be an array of objects. Log the result. */
const uniswithUni = [];
const word1 = "University";
const word2 = "Universitat";
const word3 = "Universidad";

for (i = 0; i < graduates.length; i++) {
  if (graduates[i].university.includes("University")) {
    uniswithUni.push(graduates[i]);
  } else if (graduates[i].university.includes("Universitat")) {
    uniswithUni.push(graduates[i]);
  } else if (graduates[i].university.includes("Universidad")) {
    uniswithUni.push(graduates[i]);
  }
}
console.log(uniswithUni);             // COMPLETE
...
console.log(displayNames);     // COMPLETE
...
console.log(lowCaseAnimalNames);      // COMPLETE
...
console.log(lowPopulationAnimals);      // COMPLETE
...
console.log(populationTotal);      // COMPLETE
